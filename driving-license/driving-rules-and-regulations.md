...
3. Railroad Crossing Ahead
   ...
   - **Description**: Warns of a railroad crossing ahead.
...
12. Watch for Large Animals (Deer)
    ...
    - **Description**: Warns of deer crossing the road.
...
4. Bus Stop
   ...
   - **Description**: Indicates a bus stop.
...
13. Pedestrian Zone
    ...
    - **Description**: Indicates a pedestrian-only zone.
...
7. End of Restriction
   ...
   - **Description**: Indicates the end of a restriction.
...
6. No Left Turn on Red
   ...
   - **Description**: Prohibits left turns on a red light.
...
1. **Stop Sign**
   ![Stop Sign](https://upload.wikimedia.org/wikipedia/commons/6/60/Japan_road_sign_330-A.svg)

   Octagonal red sign with "止まれ" (Tomare). Full stop required.

2. **Yield**
   ![Yield Sign](https://upload.wikimedia.org/wikipedia/commons/e/ed/Japan_road_sign_201.svg)
   Triangular white sign with a red border, indicating to yield to oncoming traffic.

3. **No Parking**
   ![No Parking](https://upload.wikimedia.org/wikipedia/commons/d/d6/Japan_road_sign_327.svg)
   Indicates areas where parking is prohibited.

4. **Pedestrian Crossing**
   ![Pedestrian Crossing](https://upload.wikimedia.org/wikipedia/commons/9/95/Japan_road_sign_302.svg)
   Warns of pedestrian crosswalks ahead.

5. **Speed Limit**
   ![Speed Limit](https://upload.wikimedia.org/wikipedia/commons/8/80/Japan_road_sign_324.svg)
   Displays the maximum allowable speed in km/h.

6. **Road Work Ahead**
   ![Road Work Ahead](https://upload.wikimedia.org/wikipedia/commons/3/3c/Japan_road_sign_145.svg)
   Indicates construction or maintenance ahead. -->
